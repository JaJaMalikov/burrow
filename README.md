...
Run `npm run serve` after building to host the `build` directory on port 8080. The server listens on all interfaces so other devices on your LAN can access the app at `http://<your-ip>:8080`.
