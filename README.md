...
To run Burrow as a web application on your local network without Electron, execute `npm run web`. This builds the web bundle and serves it at <http://localhost:3000/>.
